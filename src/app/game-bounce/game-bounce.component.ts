...
@Component({
  selector: 'sng-game-bounce',
  templateUrl: './game-bounce.component.html',
  styleUrls: ['./game-bounce.component.css']
})
export class GameBounceComponent implements OnInit {
    ...
    public gameMode: GameMode = GameMode.Bounce;
    ...
    public handlePelletConsumed(): void {
        ...
        this.score++;
        this.gameboard?.reverseSnakeDirection();
