...
@Component({
    selector: 'sng-game',
    templateUrl: './game-shadow.component.html',
    styleUrls: ['./game-shadow.component.css'],
})
export class GameShadowComponent implements OnInit {
    ...
    public gameboardConfig = gameboardConfig.mediumEven;
    public gameMode: GameMode = GameMode.Shadow;
    ...
    private async prepareGame(): Promise<void> {
        ...
        this.gameboard!.spawnShadowSnake();
        this.gameboard!.spawnPellet();
